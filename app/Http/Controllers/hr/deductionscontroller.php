...
class deductionscontroller extends Controller
{
    ...
    public function create() { return redirect()->route('deductions.index'); }
    public function edit($id) { return redirect()->route('deductions.index'); }
    ...
    public function show($id)
    {
        ...
        return response()->json(['success' => true, 'data' => $this->dto($d)]);
    }
