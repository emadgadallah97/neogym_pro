...
return [
  ...
  // ✅ مفاتيح الهيكلة الجديدة
  'save_and_print' => 'حفظ وطباعة الفاتورة',
  'view_subscriptions_list' => 'عرض الاشتراكات الحالية',
  'back_to_sales' => 'العودة لصفحة المبيعات',
  'no_offer_selected' => 'بدون عرض (اختر يدوياً)',
  ...
  'invoice_footer' => 'شكرًا لاشتراكك',
  'print' => 'طباعة',
  'item' => 'البند',
  'details' => 'التفاصيل',

  // العمولة
  'commission_type_percent' => 'نسبة %',
