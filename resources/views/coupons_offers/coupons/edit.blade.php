...
@section('title')
{{ trans('coupons_offers.edit_coupon') }}
@stop
...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">{{ trans('coupons_offers.edit') }} - {{ $Coupon->code }}</h4>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('coupons.update', $Coupon->id) }}" method="post">
                    ...
                    @include('coupons_offers.coupons._form', ['Coupon' => $Coupon, 'Plans' => $Plans, 'Types' => $Types, 'Members' => $Members])
