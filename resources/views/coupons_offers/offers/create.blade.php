...
@section('title')
{{ trans('coupons_offers.create_offers') }}
@stop
...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">{{ trans('coupons_offers.add_new_offer') }}</h4>
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="{{ route('offers.index') }}">{{ trans('coupons_offers.offers') }}</a></li>
                    <li class="breadcrumb-item active">{{ trans('coupons_offers.add_new_offer') }}</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="card">
            ...
            <div class="card-header">
                <div class="d-flex align-items-center justify-content-between">
                    <h5 class="card-title mb-0">{{ trans('coupons_offers.add_new_offer') }}</h5>
            ...
            <div class="card-body">
                <form action="{{ route('offers.store') }}" method="post">
                    ...
                    @include('coupons_offers.offers._form', ['Offer' => null, 'Plans' => $Plans, 'Types' => $Types])
