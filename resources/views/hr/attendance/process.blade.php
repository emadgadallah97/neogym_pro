...
{{-- GET: فلاتر فقط --}}
<form id="processFilterForm" method="GET" action="{{ route('attendance.process.index') }}" class="card border-0 shadow-sm mb-3">
    <div class="card-body">
...
<div class="card border-0 shadow-sm">
    ...
    <div class="card-body">
        <table id="logsTable" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
            <thead>
                <tr>
                    <th>#</th>
