        ...
        <div class="card report-card h-100 shadow-sm border-0">
            <div class="card-body d-flex flex-column text-center p-3">
                ...
                <p class="text-muted mb-3 small">
                    {{ trans('hr.attendances_desc') ?? 'تسجيل ومتابعة حضور وانصراف الموظفين' }}
                </p>
                <div class="mt-auto">
    ...
    <div class="col">
        <div class="card report-card h-100 shadow-sm border-0">
            <div class="card-body d-flex flex-column text-center p-3">
                ...
                <p class="text-muted mb-3 small">
                    {{ trans('hr.advances_desc') ?? 'إدارة طلبات السلف وتتبع الأقساط الشهرية' }}
                </p>
                <div class="mt-auto">
    ...
    <div class="col">
        <div class="card report-card h-100 shadow-sm border-0">
            <div class="card-body d-flex flex-column text-center p-3">
                ...
                <p class="text-muted mb-3 small">
                    {{ trans('hr.deductions_desc') ?? 'تسجيل الخصومات والجزاءات وتطبيقها على الرواتب' }}
                </p>
                <div class="mt-auto">
    ...
    <div class="col">
        <div class="card report-card h-100 shadow-sm border-0">
            <div class="card-body d-flex flex-column text-center p-3">
                ...
                <p class="text-muted mb-3 small">
                    {{ trans('hr.overtime_desc') ?? 'إدارة ساعات العمل الإضافي' }}
                </p>
                <div class="mt-auto">
    ...
    <div class="col">
        <div class="card report-card h-100 shadow-sm border-0">
            <div class="card-body d-flex flex-column text-center p-3">
                ...
                <p class="text-muted mb-3 small">
                    {{ trans('hr.allowances_desc') ?? 'إدارة المكافآت والبدلات' }}
                </p>
                <div class="mt-auto">
    ...
    <div class="col">
        <div class="card report-card h-100 shadow-sm border-0">
            <div class="card-body d-flex flex-column text-center p-3">
                ...
                <p class="text-muted mb-3 small">
                    {{ trans('hr.payrolls_desc') ?? 'إعداد كشوف الرواتب الشهرية واعتمادها وصرفها' }}
                </p>
                <div class="mt-auto">
    ...
    <div class="col">
        <div class="card report-card h-100 shadow-sm border-0">
            <div class="card-body d-flex flex-column text-center p-3">
                ...
                <p class="text-muted mb-3 small">
                    {{ trans('hr.devices_desc') ?? 'إدارة أجهزة البصمة ومزامنة بيانات الحضور' }}
                </p>
                <div class="mt-auto">
    ...
    <div class="col">
        <div class="card report-card h-100 shadow-sm border-0">
            <div class="card-body d-flex flex-column text-center p-3">
                ...
                <p class="text-muted mb-3 small">
                    {{ trans('hr.employees_desc') ?? 'إدارة بيانات الموظفين والوظائف والفروع' }}
                </p>
                <div class="mt-auto">
    ...
    <div class="col">
        <div class="card report-card h-100 shadow-sm border-0">
            <div class="card-body d-flex flex-column text-center p-3">
                ...
                <p class="text-muted mb-3 small">
                    {{ trans('hr.shifts_desc') ?? 'إدارة الورديات (مواعيد العمل وأيام الدوام والسماح)' }}
                </p>
                <div class="mt-auto">
    ...
    <div class="col">
        <div class="card report-card h-100 shadow-sm border-0">
            <div class="card-body d-flex flex-column text-center p-3">
                ...
                <p class="text-muted mb-3 small">
                    {{ trans('hr.employee_shifts_desc') ?? 'تحديد وردية لكل موظف حسب الفرع وفترة السريان' }}
                </p>
                <div class="mt-auto">
