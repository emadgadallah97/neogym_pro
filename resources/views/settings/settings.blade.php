            ...
            <div class="row">
                ...
                <div class="col-xxl-4 col-lg-6">
                    <div class="card card-body text-center">
                        ...
                        <h4 class="card-title font">
                            {{ trans('settings_trans.branches_settings') }}
                        </h4>
                ...
                <div class="col-xxl-4 col-lg-6">
                    <div class="card card-body text-center">
                        ...
                        <h4 class="card-title font">
                            {{ trans('settings_trans.subscriptions_types') }}
                        </h4>

                        <a href="{{ route('subscriptions_types.index') }}" class="btn btn-info">
                            {{ trans('settings_trans.Go_to_subscriptions_types_now') }}
                        </a>
                    </div>
                </div>
                ...
                <div class="col-xxl-4 col-lg-6">
                    <div class="card card-body text-center">
                        ...
                        <a href="{{ route('commission_settings.index') }}" class="btn btn-info">
                            {{ trans('settings_trans.Go_to_commission_settings_now') }}
                        </a>
                    </div>
                </div>
