        ...
        <div class="card">
            ...
            <div class="card-header">
                <div class="d-flex align-items-center justify-content-between">
                    <h5 class="card-title mb-0">{{ trans('subscriptions.edit_plan') }} - {{ $Plan->code }}</h5>

                    <div class="d-flex gap-2">
                        {{-- <a href="{{ route('subscriptions_plans.show', $Plan->id) }}" class="btn btn-soft-primary btn-sm">
                            <i class="ri-eye-fill align-bottom me-1"></i> {{ trans('subscriptions.view') }}
                        </a> --}}
            ...
            <div class="card-body">
                <form action="{{ route('subscriptions_plans.update', $Plan->id) }}" method="post" id="planForm">
                    {{ method_field('patch') }}
                    @csrf
